...
//        }
    ...
    public Completable push() {
        return Completable.create(e -> {
            ...
            /*updateIndex suspendido por el momento*/
    ...
    public Completable goOnline() {
        ...
        Log.e(TAG, "goOnline");
        Log.e(TAG, "model.getEntityID()::" + model.getEntityID());
        ...
        //Log.e(TAG, "getUserAgentToken:::" + getUserAgentToken());
        //Completable c1 = FirebaseRX.set(FirebasePaths.userRef("dcb3429a-0f85-67b4-db5c-7c38573c99b2").child(model.getEntityID()), map,true);
    ...
    public static void setUserAgentToken(String userAToken) {
        userAgentToken = userAToken;
    }
    public static void setInitialIntent(Intent initialIntent) {
        initIntent = initialIntent;
    }

    public static Intent getInitialIntent() {
        return initIntent;
    }
